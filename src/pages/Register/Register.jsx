  ...
  const InputHandler = (e) => {
    ...
    setCredentials((prevState) => ({
     ...
     return (
        ...
        <div className="formTxt"> Contraseña:
        <InputText 
            type={"password"}
        ...
        <div className="formTxt">Apellido:
        <InputText 
            type={"text"}
        ...
        <div className="formTxt">Documento de identidad
        <InputText 
            type={"text"}
        ...
        <div className="formTxt">Fecha de nacimiento
        <InputText 
            type={"text"}
        ...
        <div className="formTxt">Dirección:
        <InputText 
            type={"text"}
        ...
        <div className="formTxt">Teléfono móvil
        <InputText 
            type={"text"}
        ...
        <div className="formTxt">Número de colegiado
        <InputText 
            type={"integer"}
